...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials[Rails.env.to_sym][:mailjet][:username]
  config.secret_key = Rails.application.credentials[Rails.env.to_sym][:mailjet][:password]
  config.default_from = Rails.application.credentials[Rails.env.to_sym][:mailjet][:email_sender]
